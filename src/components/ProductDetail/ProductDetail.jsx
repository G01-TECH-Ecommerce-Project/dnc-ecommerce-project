import './index.scss';
import cartButton from '../../assets/imgs/cart-button.png';
    ...
    <div className="product-detail">
      <div className="left">
        ...
        <div className="left__bottom">
          ...
          <p className='left__bottom-description'>Lorem ipsum dolor, sit amet consectetur</p>
        </div>
      </div>
      <div className="right">
        ...
        <div className="right__detail">
          ...
          <button className="right__button"><img src={cartButton} alt="Cart" />Adicionar ao carrinho</button>
        </div>
      </div>
    </div>
  )
